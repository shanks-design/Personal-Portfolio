              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-900">Read Write Own</span>
                    <span className="text-sm text-gray-500">by Chris Dixon</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-sm text-gray-500">Next</span>
                    <span className="text-gray-900">Creative Act</span>
                    <span className="text-sm text-gray-500">by Rick Rubin</span>
                  </div>
                </div>
              </div>
            </div>
